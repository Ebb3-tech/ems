            ...
            <div class="card border-0 shadow-sm bg-white">
                ...
                <div class="card-body">
                    <div class="d-grid gap-3">
                        ...
                        <a href="{{ route('callcenter.index') }}" class="btn btn-outline-info d-flex align-items-center justify-content-start py-3 border-2 text-start">
                            <div class="bg-info bg-opacity-10 rounded-2 p-2 me-3">
                                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" class="text-info">
                                    <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path>
                                    <polyline points="14,2 14,8 20,8"></polyline>
                            ...
                            <div>
                                ...
                                <small class="text-muted">Go to hamubere dashboard and discover more</small>
                            </div>
                        </a>
                    </div>
                </div>
