...
<div class="container mt-3">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h2 class="fw-bold text-primary"><i class="fas fa-building me-2"></i>Departments</h2>
        <div>
        ...
        <div class="card-body p-0">
                        ...
                        <tbody>
                            @foreach($departments as $department)
                                <tr>
                                    ...
                                    <td>
                                        <span class="text-truncate d-inline-block" style="max-width: 500px;" title="{{ $department->description }}">
                                            {{ $department->description ?: 'No description available' }}
                                        </span>
                                    </td>
                                    <td class="text-end pe-3">
                                        <a href="{{ route('departments.edit', $department) }}" class="btn btn-sm btn-outline-warning me-1" title="Edit department">
            ...
            @else
                <div class="text-center py-5">
                    ...
                    <a href="{{ route('departments.create') }}" class="btn btn-primary">
                        <i class="fas fa-plus-circle me-1"></i> Create Your First Department
                    </a>
                </div>
            @endif
        </div>
